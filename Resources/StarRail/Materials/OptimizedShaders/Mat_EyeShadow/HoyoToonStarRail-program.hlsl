...
float4 ps_base(vs_out i, bool vface : SV_IsFrontFace) : SV_Target
{
    ...
    float4 lut_bloomval = _MaterialValuesPackLUT.Load(float4(material_ID, 7, 0, 0)); // x: rim shadow width, y: rim shadow feather 
        ...
        float shadow_area = 1.0f;
            ...
            if((0.0 /*_EnableShadow*/) == 1)
            {
                ...
                if ((0.0 /*_ES_LEVEL_ADJUST_ON*/))
                {
                    ...
                    isSkin = ((0.0 /*_FaceMaterial*/)) ? 0.0 : isSkin;
        ...
        #endif
        out_color = ((0.0 /*_StarrySky*/) && !(0.0 /*_FaceMaterial*/) && !(0.0 /*_HairMaterial*/)) ? starry_sky(diffuse, out_color, uv) : out_color * diffuse;
        ...
        #endif
        #if defined(use_rimlight)
            if(!(0.0 /*_FaceMaterial*/) && (0.0 /*_EnableRimLight*/)) out_color.xyz = lerp(out_color.xyz.xyz - rim_light.xyz, out_color.xyz + rim_light.xyz, rim_values[curr_region].z);
        #endif
        ...
        shadow_area = shadow_rate(ndotl, lightmap.y, i.v_col.x, 1.0f);
            ...
            if((0.0 /*_FaceMaterial*/)) shadow_area = ndotl;
        #endif
